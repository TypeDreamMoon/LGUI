 ...
 */
UCLASS( ClassGroup=(LGUI), meta=(BlueprintSpawnableComponent, DisplayName = "Vertical Box Layout") )
...
UCLASS(ClassGroup = LGUI, Blueprintable, meta = (DisplayName = "Vertical Box Slot"))
